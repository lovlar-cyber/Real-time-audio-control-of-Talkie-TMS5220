...
#define FIFO_BUFFER_SIZE 1 // 24 sets of 4 bytes plus added queue indexes is about 100 added bytes.
...
public:
    ...
    //egna funktioner
    //volatile bool useFakeEnergy;
    void setFakeEnergy(bool uFE, uint8_t val);
    //uint8_t fakeEnergy;
